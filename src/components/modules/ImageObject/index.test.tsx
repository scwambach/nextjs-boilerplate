...
describe('ImageObject Component', () => {
  ...
  it('always requires and forwards a meaningful alt attribute for the rendered image', () => {
    const { getByAltText } = render(
      <ImageObject alt="A description" width={100} height={100} />
    )
    expect(getByAltText('A description')).toBeInTheDocument()
  })
})
