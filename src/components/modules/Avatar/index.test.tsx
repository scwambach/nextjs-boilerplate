...
describe('Avatar', () => {
  ...
  it('hides the decorative monogram from assistive tech while exposing the full name', () => {
    const { getByText, container } = render(
      <Avatar firstName="John" lastName="Doe" />
    )
    expect(getByText('JD')).toHaveAttribute('aria-hidden', 'true')
    expect(container.querySelector('.srOnly')).toHaveTextContent('JohnDoe')
  })
})
