...
describe('Card Component', () => {
  ...
  it('renders the date in a semantic time element with a machine-readable datetime attribute', () => {
    const { container } = render(<Card {...cardPropsWithLinks} />)
    const timeEl = container.querySelector('time')
    expect(timeEl).toBeInTheDocument()
    expect(timeEl).toHaveAttribute('datetime', '2024-02-20')
  })
})
