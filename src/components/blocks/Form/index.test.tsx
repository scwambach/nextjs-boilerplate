...
describe('Form component', () => {
  ...
  it('groups form fields within a fieldset for accessibility', () => {
    const { getByTestId } = render(<Form testId="form" />)
    const form = getByTestId('form')
    expect(form.querySelector('fieldset')).toBeInTheDocument()
  })
})
