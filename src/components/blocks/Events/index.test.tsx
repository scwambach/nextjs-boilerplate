...
describe('Events Component', () => {
  ...
  it('renders a heading with an accessible heading level when provided', () => {
    const { getByText } = render(
      <Events items={events} heading="Upcoming Events" headingLevel={2} />
    )
    expect(getByText('Upcoming Events').tagName).toBe('H2')
  })
})
