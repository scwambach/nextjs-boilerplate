...
describe('Gallery Component', () => {
  ...
  ] as unknown as GalleryProps['items']
  ...
  it('provides an accessible name on each gallery item button', () => {
    const { getByTestId } = render(<Gallery {...defaultProps} />)
    expect(getByTestId('galleryTestId-item-0')).toHaveAttribute(
      'aria-label',
      'Image 1'
    )
  })
