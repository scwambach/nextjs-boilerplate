...
describe('People Component', () => {
  ...
  it('renders the heading using a semantic heading level for accessibility', () => {
    const { getByText } = render(
      <People items={[]} heading="People List" headingLevel={3} />
    )
    expect(getByText('People List').tagName).toBe('H3')
  })
})
