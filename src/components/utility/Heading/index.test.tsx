...
describe('Heading Component', () => {
  ...
  it('supports visually-styled non-heading elements while preserving semantics via nonHeadingElement', () => {
    const { getByText } = render(
      <Heading level={2} nonHeadingElement="span">
        Styled text
      </Heading>
    )
    const heading = getByText('Styled text')
