...
describe('Modal Component', () => {
  ...
  it('exposes dialog semantics and keeps aria-expanded/aria-modal/aria-hidden in sync with open state', () => {
    const { getByText } = render(<Modal {...defaultProps} />)
    const triggerButton = getByText(triggerCopy)
    const dialog = document.querySelector('.modalBox') as HTMLElement
